				...
				else if (ase instanceof AccessDeniedException)
				{
					...
					if (authenticationTrustResolver.isAnonymous(SecurityContextHolder.getContext().getAuthentication()))
					{
						...
						if ("XMLHttpRequest".equals(ajaxHeader))
						{
							...
							System.out.println("if AjaxTimeoutRedirectFilter.doFilter()");
						...
						{
							System.out.println("else AjaxTimeoutRedirectFilter.doFilter()");
							logger.info("Redirect to login page");
							HttpServletResponse resp = (HttpServletResponse) response;
							HttpServletRequest resq = (HttpServletRequest) request;
 							resp.sendRedirect(resq.getContextPath()+"/sessionexpired");  
							//throw ase; 
						} 
					}
					else
