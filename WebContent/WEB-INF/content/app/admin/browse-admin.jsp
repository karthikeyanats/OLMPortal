...
<div class="tab-content padtop7">
	<div class="tab-pane" id="learningcoursegridview">
		...
		<div class="col-md-3 pad5">
			<div class="col-md-12 whitebg boxshadow" style="box-shadow: 0px 1px 10px rgba(40,45,47,0.30);height: 284px;background: white;">
				<div class="row">
	...
	<div class="tab-pane" id="learningcourslistview">
		...
		<div class="row whitebg mar0 marbottom10 boxshadow">
			<div class="col-md-12 pad0">
				...
				<div class="col-md-10" style="box-shadow: 0px 1px 10px rgba(40,45,47,0.30);height: 142px;background: white;">
						...
						<div class="col-md-12">
							...
							<div class="col-md-6 righttext">
								<a class="btn btn-primary pull-right  managecourse"
									courseid="{{courseid}}" ><i
									class="fa fa-pencil" style="color:#fff"><span style="color:#fff">&nbsp;Manage</span></i></a> 
								<a class="btn btn-primary usercount pull-right marright7"
									courseid="{{courseid}}" data-toggle="modal" href="#courseUserModel"
									coursetitle="{{coursetitle}}"><i class="fa fa-users" style="color:#fff"><span style="color:#fff">&nbsp;Users</span></i></a>								
							</div>
						</div>
					</div>
		...
		<div class="row">
			<div class="col-md-12 pad0">
				<div class="col-md-3 pad0 martop10" >
					<ul class="pad0" id="topcategoriestable" style="box-shadow: 0px 1px 10px rgba(40,45,47,0.30);height: 255px;background: white;">
					</ul>
				</div>
