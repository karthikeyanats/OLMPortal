...
(function (factory) {
  ...
  var settings = {
    ...
    options: {
      ...
      toolbar: [
        ...
        ['height', ['height']],
        ['table', ['table']],
        ['insert', ['link', 'picture','drawing','hr']],
  ...
  var Dialog = function () {
     ...
     * 
     */
    	/*this.showWhiteDiolog = function ($editable, $dialog) {
  ...
  var EventHandler = function () {
    ...
    var commands = {
      ...
      /**
       * show Whiteboard window
       * @param layoutInfo
       */
      showWhiteDiolog:function(layoutInfo){
          $editable = layoutInfo.editable();
    	  var callbacks = $editable.data('callbacks');
          if (callbacks.onDrawingWindow) {
            callbacks.onDrawingWindow(editor,$editable);
          }
      },
    ...
    this.attach = function (layoutInfo, options) {
      ...
      layoutInfo.editable.data('callbacks', {
        ...
        onDrawingWindow: options.onDrawingWindow
      });
    };
  ...
  var Renderer = function () {
    ...
    var tplButtonInfo = {
      ...
      drawing:function(lang){
    	  return tplIconButton('fa fa-edit', {
              event: 'showWhiteDiolog',
              title: lang.image.drawing
            });
      },
      link: function (lang) {
