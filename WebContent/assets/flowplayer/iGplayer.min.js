...
!function(e) {	
    ...
    function t(t, n) {
        ...
        var r = {width: "100%",height: "100%",allowscriptaccess: "always",wmode: "transparent",quality: "high",flashvars: "",movie: t + (e.browser.msie ? "?" + i : ""),name: i};
    ...
    function s(t) {
        ...
        e("source", t).each(function() {
            i.push(o(e(this)))
        }), i.length || i.push(o(t)), n.initialSources = i, n.resolve = function(t) {
    ...
    e.fn.flowplayer = function(t, n) {
        return "string" == typeof t && (t = {swf: t}), e.isFunction(t) && (n = t, t = {}), !t && this.data("flowplayer") || this.each(function() {
            var i, a, r = e(this).addClass("is-loading"), o = e.extend({}, flowplayer.defaults, flowplayer.conf, t, r.data()), l = e("video", r).addClass("fp-engine").removeAttr("controls"), d = l.length ? new s(l) : null, f = {};
            if (o.playlist.length) {
                var v, g = l.attr("preload");
                l.length && l.replaceWith(v = e("<p />")), l = e("<video />").addClass("fp-engine"), v ? v.replaceWith(l) : r.prepend(l), l.attr("preload", g), "string" == typeof o.playlist[0] ? l.attr("src", o.playlist[0]) : e.each(o.playlist[0], function(t, n) {
                    for (var i in n)
            ...
            y && r.addClass("is-rtl");
            var b = m || {conf: o,currentSpeed: 1,volumeLevel: "undefined" == typeof o.volume ? 1 * f.volume : o.volume,video: {},disabled: !1,finished: !1,loading: !1,muted: "true" == f.muted || o.muted,paused: !1,playing: !1,ready: !1,splash: !1,rtl: y,load: function(t, n) {
                    if (!(b.error || b.loading || b.disabled)) {
                        if (t = d.resolve(t), e.extend(t, a.pick(t.sources)), t.src) {
                            var i = e.Event("load");
                            r.trigger(i, [b, t, a]), i.isDefaultPrevented() ? b.loading = !1 : (a.load(t), e.isFunction(t) && (n = t), n && r.one("ready", n))
                        }
                        return b
                    }
                },pause: function(e) {
                    ...
                    return b.ready && b.paused && !b.disabled && (a.resume(), b.finished && (b.trigger("resume"), b.finished = !1)), b
                },toggle: function() {
                    ...
                    if (b.ready) {
                        ...
                        r.trigger(s, [b, t]), s.isDefaultPrevented() ? (b.seeking = !1, r.toggleClass("is-seeking", b.seeking)) : (a.seek(t), e.isFunction(n) && r.one("seek", n))
                    }
                    return b
                },seekTo: function(e, t) {
                    ...
                    return void 0 === e && (e = !b.muted), f.muted = b.muted = e, f.volume = isNaN(f.volume) ? o.volume : f.volume, b.volume(e ? 0 : f.volume, !0), b.trigger("mute", e), b
                },volume: function(e, t) {
                    return b.ready && (e = Math.min(Math.max(e, 0), 1), t || (f.volume = e), a.volume(e)), b
                },speed: function(t, n) {
                    return b.ready && ("boolean" == typeof t && (t = o.speeds[e.inArray(b.currentSpeed, o.speeds) + (t ? 1 : -1)] || b.currentSpeed), a.speed(t), n && r.one("speed", n)), b
                },stop: function() {
                    return b.ready && (b.pause(), b.seek(0, function() {
                        r.trigger("stop")
                    })), b
                },unload: function() {
                    return r.hasClass("is-embedding") || (o.splash ? (b.trigger("unload"), a.unload()) : b.stop()), b
                },disable: function(e) {
                    return void 0 === e && (e = !b.disabled), e != b.disabled && (b.disabled = e, b.trigger("disable", e)), b
                }};
            b.conf = e.extend(b.conf, o), e.each(["bind", "one", "unbind"], function(e, t) {
                b[t] = function(e, n) {
                    return r[t](e, n), b
                }
                ...
                return e.each(["autoplay", "loop", "preload", "poster"], function(e, t) {
                    var n = l.attr(t);
                    void 0 !== n && (o[t] = n ? n : !0)
                }), (o.splash || r.hasClass("is-splash") || !flowplayer.support.firstframe) && (b.forcedSplash = !o.splash && !r.hasClass("is-splash"), b.splash = o.splash = o.autoplay = !0, r.addClass("is-splash"), l.attr("preload", "none")), e.each(c, function() {
                    this(b, r)
                }), a = flowplayer.engine[o.engine], a && (a = a(b, r)), a.pick(d.initialSources) ? b.engine = o.engine : e.each(flowplayer.engine, function(e) {
                    return e != o.engine ? (a = this(b, r), a.pick(d.initialSources) && (b.engine = e), !1) : void 0
                }), u.push(b), b.engine ? (o.splash ? b.unload() : b.load(), o.disabled && b.disable(), a.volume(b.volumeLevel), r.one("ready", n), void 0) : b.trigger("error", {code: flowplayer.support.flashVideo ? 5 : 10})
            }).bind("load", function(t, n) {
                o.splash && e(".flowplayer").filter(".is-ready, .is-loading").not(r).each(function() {
                    var t = e(this).data("flowplayer");
                    t.conf.splash && t.unload()
                }), r.addClass("is-loading"), n.loading = !0
            }).bind("ready", function(e, t, n) {
                function i() {
                    r.removeClass("is-loading"), t.loading = !1
                }
                n.time = 0, t.video = n, o.splash ? r.one("progress", i) : i(), t.muted ? t.mute(!0) : t.volume(t.volumeLevel)
            }).bind("unload", function() {
                o.splash && l.remove(), r.removeClass("is-loading"), b.loading = !1
            }).bind("ready unload", function(e) {
                var t = "ready" == e.type;
                r.toggleClass("is-splash", !t).toggleClass("is-ready", t), b.ready = t, b.splash = !t
                ...
                b.seeking = "beforeseek" == e.type, r.toggleClass("is-seeking", b.seeking)
            }).bind("ready pause resume unload finish stop", function(e, t, n) {
                b.paused = /pause|finish|unload|stop/.test(e.type), "ready" == e.type && (b.paused = "none" == o.preload, n && (b.paused = !n.duration || !o.autoplay && "none" != o.preload)), b.playing = !b.paused, r.toggleClass("is-paused", b.paused).toggleClass("is-playing", b.playing), b.load.ed || b.pause()
        ...
        e.extend(n, {subtitles: !!a.addTextTrack,fullscreen: !u && ("function" == typeof document.webkitCancelFullScreen && !/Mac OS X 10_5.+Version\/5\.0\.\d Safari/.test(o) || document.mozFullScreenEnabled || "function" == typeof document.exitFullscreen),inlineBlock: !(r && i.version < 8),touch: "ontouchstart" in window,dataload: !s && !d && !p,zeropreload: !r && !u,volume: !(s || u || d || f || l),cachedVideoTag: !(s || d || l || p),firstframe: !(d || s || u || f || l || p || c),inlineVideo: !d && !f && !p && (!u || v >= 3),hlsDuration: !i.safari || s || d || l,seekable: !s && !l});
        try {
            var g = r ? new ActiveXObject("ShockwaveFlash.ShockwaveFlash").GetVariable("$version") : navigator.plugins["Shockwave Flash"].description;
            g = g.split(/\D+/), g.length && !g[0] && (g = g.slice(1)), n.flashVideo = g[0] > 9 || 9 == g[0] && g[3] >= 115
        } catch (m) {
        }
        try {
        ...
        var l = {pick: function(t) {
                ...
                if (is_absolute = /^https?:/.test(c), u.length > 0 && flowplayer.support.video && u[0].pause(), u.remove(), is_absolute || s.rtmp || (c = e("<img/>").attr("src", c)[0].src), o)
                    o.__play(c);
                else {
                    ...
                    i.data("origin") && (f.origin = i.data("origin")), is_absolute && delete s.rtmp, e.each(["key", "autoplay", "preload", "rtmp", "loop", "debug", "preload", "splash"], function(e, t) {
                        s[t] && (f[t] = s[t])
                    }), f.rtmp && (f.rtmp = d(f.rtmp)), r = t(s.swf, f), r.prependTo(i), o = r[0], setTimeout(function() {
                        try {
                            if (!o.PercentLoaded())
                ...
                o && o.__unload && o.__unload(), delete e[a], e("object", i).remove(), o = 0
            }};
        e.each("pause,resume,seek,volume".split(","), function(e, t) {
            l[t] = function(e) {
                n.ready && ("seek" == t && n.video.time && !n.paused && n.trigger("beforeseek"), void 0 === e ? o["__" + t]() : o["__" + t](e))
            }
        });
        var d = e(window);
        return n.bind("ready fullscreen fullscreen-exit", function(t) {
            ...
            if (n.conf.flashfit || /full/.test(t.type)) {
                var o, s, l = n.isFullscreen, u = l && F, c = !flowplayer.support.inlineBlock, f = l ? u ? screen.availWidth : d.width() : r, p = l ? u ? screen.availHeight : d.height() : a, v = u ? screen.width - screen.availWidth : 0, g = u ? screen.height - screen.availHeight : 0, m = c ? r : "", h = c ? a : "";
                (n.conf.flashfit || "fullscreen" === t.type) && (o = n.video.width / n.video.height, s = n.video.height / n.video.width, h = Math.max(s * f), m = Math.max(o * p), h = h > p ? m * s : h, h = Math.min(Math.round(h), p), m = m > f ? h * o : m, m = Math.min(Math.round(m), f), g = Math.max(Math.round((p + g - h) / 2), 0), v = Math.max(Math.round((f + v - m) / 2), 0)), e("object", i).css({width: m,height: h,marginTop: g,marginLeft: v})
            }
        }), l
    };
    var v, g = e("<video/>")[0], m = {ended: "finish",pause: "pause",play: "resume",progress: "buffer",timeupdate: "progress",volumechange: "volume",ratechange: "speed",seeked: "seek",loadeddata: "ready",error: "error",dataunavailable: "error"}, h = function(t) {
    ...
    flowplayer.engine.html5 = function(t, i) {
        function o(r, o, s) {
            r.listeners && r.listeners.hasOwnProperty(i.data("fp-player_id")) || ((r.listeners || (r.listeners = {}))[i.data("fp-player_id")] = !0, o.bind("error", function(n) {
                try {
                ...
                r.addEventListener(a, function(d) {
                    if ("progress" == o && d.srcElement && 0 === d.srcElement.readyState && setTimeout(function() {
                        t.video.duration || (o = "error", t.trigger(o, {code: 4}))
                    }, 1e4), p.debug && !/progress/.test(o) && console.log(a, "->", o, d), (t.ready || /ready|error/.test(o)) && o && e("video", i).length) {
                        var u, f = e.Event(o);
                        switch (o) {
                            case "ready":
                                u = e.extend(s, {duration: r.duration,width: r.videoWidth,height: r.videoHeight,url: r.currentSrc,src: r.currentSrc});
                                try {
                                ...
                                if (l = l || setInterval(function() {
                                    ...
                                    var g = function() {
                                        ...
                                        t.trigger(f, u), r.removeEventListener("durationchange", g)
                                    };
        ...
        return s = {pick: function(e) {
                ...
                if (p.splash && !d)
                    u = h(n).prependTo(i), c.inlineVideo || u.css({position: "absolute",top: "-9999em"}), f.length && u.append(f.attr("default", "")), p.loop && u.attr("loop", "loop"), d = u[0];
                else {
                    d = u[0];
                    var a = u.find("source");
                ...
                o(d, e("source", u).add(u), n), "none" == p.preload && c.zeropreload && c.dataload || d.load(), p.splash && d.load()
            },pause: function() {
                d.pause()
            },resume: function() {
                d.play()
    ...
    e.throttle = function(e, t) {
        ...
        return this.each(function() {
            var i, a, r, o, s, l, d, u, c = e(this), f = e(document), p = c.children(":last"), v = !1, g = function() {
                a = c.offset(), r = c.width(), o = c.height(), l = s ? o : r, u = b(d)
            }, m = function(e) {
        ...
        t.bind("ready", function() {
            ...
            if (n.removeClass("is-loading").addClass("is-error"), a) {
                ...
                e("h2", r).text((i.engine || "html5") + ": " + a.message), e("p", r).text(a.url || i.video.url || i.video.src || s.errorUrls[a.code]), n.unbind("mouseenter click").removeClass("is-mouseover")
            }
        }).bind("mouseenter mouseleave", function(e) {
            if (!T) {
                var t, i = "mouseenter" == e.type;
                r(i), i ? (n.bind("pause.x mousemove.x volume.x", function() {
                    r(!0), t = new Date
                }), o = setInterval(function() {
                    new Date - t > 5e3 && (r(!1), t = new Date)
                }, 100)) : (n.unbind(".x"), clearInterval(o))
            }
    ...
    e(document).bind("keydown.fp", function(t) {
        var n = b, i = t.ctrlKey || t.metaKey || t.altKey, a = t.which, r = n && n.conf;
        if (n && r.keyboard && !n.disabled) {
            if (-1 != e.inArray(a, [63, 187, 191, 219]))
                return w.toggleClass(k), !1;
            if (27 == a && w.hasClass(k))
                return w.toggleClass(k), !1;
            if (!i && n.ready) {
    ...
    var x, C = e.browser.mozilla ? "moz" : "webkit", T = "fullscreen", S = "fullscreen-exit", F = flowplayer.support.fullscreen, _ = "function" == typeof document.exitFullscreen, E = navigator.userAgent.toLowerCase(), M = /(safari)[ \/]([\w.]+)/.exec(E) && !/(chrome)[ \/]([\w.]+)/.exec(E);
    e(document).bind(_ ? "fullscreenchange" : C + "fullscreenchange", function(t) {
        ...
        var r = e.extend({active: "is-active",advance: !0,query: ".fp-playlist a"}, t.conf), o = r.active;
        t.play = function(n) {
        ...
        }, e(".fp-next", n).click(t.next), e(".fp-prev", n).click(t.prev), r.advance && n.unbind("finish.pl").bind("finish.pl", function(e, t) {
            var i = t.video.index + 1;
            i < t.conf.playlist.length || r.loop ? (i = i === t.conf.playlist.length ? 0 : i, n.removeClass("is-finished"), setTimeout(function() {
                t.play(i)
        ...
        if (i().length) {
            s || (t.conf.playlist = [], i().each(function() {
                ...
                n.preventDefault();
                var i = e(n.target).closest(r.query), a = Number(i.attr("data-index"));
                -1 != a && t.play(a)
            });
            var u = i().filter("[data-cuepoints]").length;
            t.bind("load", function(i, r, s) {
                var l = a().removeClass(o), d = l.attr("data-index"), c = s.index = t.video.index || 0, f = e('a[data-index="' + c + '"]', n).addClass(o), p = c == t.conf.playlist.length - 1;
                n.removeClass("video" + d).addClass("video" + c).toggleClass("last-video", p), s.index = r.video.index = c, s.is_last = r.video.is_last = p, u && (t.cuepoints = f.data("cuepoints"))
    ...
    flowplayer(function(t, n) {
        function i(e) {
            n[0].className = n[0].className.replace(D, " "), e >= 0 && n.addClass("cue" + e)
        }
        var a = 0;
        t.cuepoints = t.conf.cuepoints || [], t.bind("progress", function(e, r, o) {
            if (a && .015 > o - a)
                return a = o;
            a = o;
            for (var s, l = t.cuepoints || [], d = 0; d < l.length; d++)
                s = l[d], isNaN(s) || (s = {time: s}), s.time < 0 && (s.time = t.video.duration + s.time), s.index = d, Math.abs(s.time - o) < .125 * t.currentSpeed && (i(d), n.trigger("cuepoint", [t, s]))
        }).bind("unload seek", i), t.conf.generate_cuepoints && t.bind("load", function() {
            e(".fp-cuepoint", n).remove()
        }).bind("ready", function() {
            var i = t.cuepoints || [], a = t.video.duration, r = e(".fp-timeline", n).css("overflow", "visible");
            e.each(i, function(n, i) {
                var o = i.time || i;
                0 > o && (o = a + i);
                var s = e("<a/>").addClass("fp-cuepoint fp-cuepoint" + n).css("left", 100 * (o / a) + "%");
        ...
        if (!flowplayer.support.subtitles || (t.subtitles = a.length && a[0].track, !r.nativesubtitles || "html5" != r.engine)) {
            ...
            if (s) {
                e.get(s, function(n) {
                    for (var a, r, s, l, d = 0, u = n.split("\n"), c = u.length, f = {}; c > d; d++)
                        if (r = o.exec(u[d])) {
                            for (a = u[d - 1], s = "<p>" + u[++d] + "</p><br/>"; e.trim(u[++d]) && d < u.length; )
                                s += "<p>" + u[d] + "</p><br/>";
                            f = {title: a,startTime: i(r[1]),endTime: i(r[2] || r[3]),text: s}, l = {time: f.startTime,subtitle: f}, t.subtitles.push(f), t.cuepoints.push(l), t.cuepoints.push({time: f.endTime,subtitleEnd: a}), 0 === f.startTime && t.trigger("cuepoint", l)
                        }
                }).fail(function() {
        ...
        function i() {
            if (r && "undefined" != typeof _gat) {
                ...
                e._setAllowLinker(!0), e._trackEvent("Video / Seconds played", t.engine + "/" + i.type, n.attr("title") || i.src.split("/").slice(-1)[0].replace(y, ""), Math.round(r / 1e3)), r = 0
            }
        }
    ...
    (flowplayer.support.touch || A) && flowplayer(function(t, n) {
        ...
        n.bind("touchmove", function() {
            ...
            return o ? (o = !1, void 0) : t.playing && !n.hasClass("is-mouseover") ? (n.addClass("is-mouseover").removeClass("is-mouseout"), !1) : (t.paused && n.hasClass("is-mouseout") && t.toggle(), t.paused && A && e("video", n)[0].play(), void 0)
        ...
        if (t.conf.embed !== !1) {
            var i = t.conf, a = e(".fp-ui", n), r = e("<a/>", {"class": "fp-embed",title: "Copy to your site"}).appendTo(a), o = e("<div/>", {"class": "fp-embed-code"}).append("<label>Paste this HTML code on your site to embed.</label><textarea/>").appendTo(a), s = e("textarea", o);
...
flowplayer(function(e, o) {
    ...
    if ("file:" == location.protocol && (l = "localhost"), e.load.ed = 1, t.hostname = l, t.origin = i || location.href, i && o.addClass("is-embedded"), "string" == typeof r && (r = r.split(/,\s*/)), r && "function" == typeof key_check && key_check(r, l))
        t.logo && o.append(n("<a>", {"class": "fp-logo",href: i}).append(n("<img/>", {src: t.logo})));
    else {
        var s = n("<a/>").attr("href", "http://www.igrandee.com").appendTo(o);
        n(".fp-controls", o), e.bind("pause resume finish unload", function(e, o) {
            //var a = o.video.src ? o.video.src.indexOf("://my.flowplayer.org") : -1;
            /pause|resume/.test(e.type) && "flash" != o.engine && 4 != a && 5 != a ? (s.show().css({position: "absolute",left: 16,bottom: 36,zIndex: 99999,width: 73,height: 20,backgroundImage: "url(iGPlayer.png)"}), o.load.ed = s.is(":visible"), o.load.ed || o.pause()) : s.hide()
        })
    }
});
