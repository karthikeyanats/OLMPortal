...
<form method="post" action="https://www.ccavenue.com/shopzone/cc_details.jsp" name="paymentform">      
	...
	<%
		...
		if(request.getServerPort() == 80) 
			Redirect_Url				+= request.getServerName()+""+request.getContextPath()+"/PaymentGateway/giftcoursecheckout.jsp?giftcourseid="+giftcourseid+"&price="+Amount+"&priceid="+priceid+"&orderid="+orderid;

		else
			Redirect_Url				+= request.getServerName()+":"+request.getServerPort()+""+request.getContextPath()+"/PaymentGateway/giftcoursecheckout.jsp?giftcourseid="+giftcourseid+"&price="+Amount+"&priceid="+priceid+"&orderid="+orderid;
