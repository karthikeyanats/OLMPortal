...
<form method="post" action="https://www.ccavenue.com/shopzone/cc_details.jsp" name="paymentform">      
	...
	<%
		...
		String Redirect_Url 			= "";
 		String Amount=(String)request.getParameter("fees");
  		String courseid = request.getParameter("courseid");
  		String livesessionid = request.getParameter("livesessionid");
		...
		if(request.getServerPort() == 80) 
			Redirect_Url				+= request.getServerName()+""+request.getContextPath()+"/PaymentGateway/checkout.jsp?courseid="+courseid+"&registerid="+registerid+"&fees="+Amount+"&priceid="+priceid+"&type="+type+"&livesessionid="+livesessionid;

		else
			Redirect_Url				+= request.getServerName()+":"+request.getServerPort()+""+request.getContextPath()+"/PaymentGateway/checkout.jsp?courseid="+courseid+"&registerid="+registerid+"&fees="+Amount+"&priceid="+priceid+"&type="+type+"&livesessionid="+livesessionid;
