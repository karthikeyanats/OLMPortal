...
<form method="post" action="https://www.ccavenue.com/shopzone/cc_details.jsp" name="paymentform">      
	...
	<%
		...
		String planpaymentid = request.getParameter("planpaymentid");
		String orgsubcriptionid = request.getParameter("orgsubcriptionid");
		...
		if(request.getServerPort() == 80) 
			Redirect_Url				+= request.getServerName()+""+request.getContextPath()+"/PaymentGateway/plancheckout.jsp?planpaymentid="+planpaymentid+"&orgsubcriptionid="+orgsubcriptionid+"&planid="+planid+"&price="+Amount+"&durationtype="+durationtype+"&duration="+duration;

		else
			Redirect_Url				+= request.getServerName()+":"+request.getServerPort()+""+request.getContextPath()+"/PaymentGateway/plancheckout.jsp?planpaymentid="+planpaymentid+"&orgsubcriptionid="+orgsubcriptionid+"&planid="+planid+"&price="+Amount+"&durationtype="+durationtype+"&duration="+duration;
		...
		Order_Id 						= request.getParameter("planpaymentid");
